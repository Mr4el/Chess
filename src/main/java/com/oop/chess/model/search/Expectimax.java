...
public class Expectimax {
    ...
    public static double[] weights_Expectimax = {1, 200, 9, 5, 3, 3, 1, 1};
    ...
    public static double expectimaxSearch(int depth, boolean is_white, boolean maximizingPlayer,
        ...
        if (depth == 0) {
            return EvaluationFunction.evaluationFunctionsCombined(Game.board, is_white, weights_Expectimax, true);
        }
        ...
        if (chanceLayer) {
            ...
            for (int i = 0; i < pieceArray.length; i++) {
                ArrayList<int[]> legalMoves = Game.getEveryLegalMoveOfPlayer(Game.board, is_white, pieceArray[i]);
                if (legalMoves != null) {
                    expectedValue += expectimaxSearch(depth, is_white, maximizingPlayer, false, pieceArray[i]);
                    possibleMovePieces++;
                }
            }
        ...
        // If the current player is maximizing, we look at the values of the layer below.
            ...
            ArrayList<int[]> moves = Game.getEveryLegalMoveOfPlayer(Game.board, is_white, currentPiece);
            double maxEvaluation = Double.MIN_VALUE;
